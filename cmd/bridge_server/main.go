...
func startServer(ctx *cli.Context) {
	...
	//priceListen.StartCoinPriceListen(config.Server, config.CoinPriceUpdateSlot, config.CoinPriceListenConfig, config.DBConfig)
	//feeListen.StartFeeListen(config.Server, config.FeeUpdateSlot, config.FeeListenConfig, config.DBConfig)
	//effectListen.StartCrossChainEffect(config.Server, config.EventEffectConfig, config.DBConfig)
}
...
func stopServer() {
	...
	priceListen.StopCoinPriceListen()
	feeListen.StopFeeListen()
	effectListen.StopCrossChainEffect()
}
