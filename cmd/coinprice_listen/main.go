...
import (
	...
	"github.com/polynetwork/poly-nft-bridge/logic/price"
...
func startServer(ctx *cli.Context) {
	...
	price.StartCoinPriceListen(config.Server, config.CoinPriceUpdateSlot, config.CoinPriceListenConfig, config.DBConfig)
}
