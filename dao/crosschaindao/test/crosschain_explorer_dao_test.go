...
import (
	...
	explorerdao2 "github.com/polynetwork/poly-bridge/dao/crosschaindao/explorerdao"
...
func TestCrossChain_ExplorerDao(t *testing.T) {
	...
	dao := explorerdao2.NewExplorerDao(config.DBConfig)
...
func TestQueryPolySrcRelation_ExplorerDao(t *testing.T) {
	...
	polySrcRelations := make([]*explorerdao2.PolySrcRelation, 0)
...
func TestUpdateTokenInfo_ExplorerDao(t *testing.T) {
	...
	{
		tokens := make([]*explorerdao2.Token, 0)
		newTokens := make([]*explorerdao2.Token, 0)
