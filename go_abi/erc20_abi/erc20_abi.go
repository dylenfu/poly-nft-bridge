...
func DeployERC20Template(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *ERC20Template, error) {
	...
	return address, tx, &ERC20Template{ERC20TemplateCaller: ERC20TemplateCaller{contract: contract}, ERC20TemplateTransactor: ERC20TemplateTransactor{contract: contract}, ERC20TemplateFilterer: ERC20TemplateFilterer{contract: contract}}, nil
}

// ERC20Template is an auto generated Go binding around an Ethereum contract.
type ERC20Template struct {
	ERC20TemplateCaller     // Read-only binding to the contract
	ERC20TemplateTransactor // Write-only binding to the contract
	ERC20TemplateFilterer   // Log filterer for contract events
}

// ERC20TemplateCaller is an auto generated read-only Go binding around an Ethereum contract.
type ERC20TemplateCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ERC20TemplateTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ERC20TemplateTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ERC20TemplateFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ERC20TemplateFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ERC20TemplateSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ERC20TemplateSession struct {
	Contract     *ERC20Template    // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ERC20TemplateCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ERC20TemplateCallerSession struct {
	Contract *ERC20TemplateCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts        // Call options to use throughout this session
}

// ERC20TemplateTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ERC20TemplateTransactorSession struct {
	Contract     *ERC20TemplateTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts        // Transaction auth options to use throughout this session
}

// ERC20TemplateRaw is an auto generated low-level Go binding around an Ethereum contract.
type ERC20TemplateRaw struct {
	Contract *ERC20Template // Generic contract binding to access the raw methods on
}

// ERC20TemplateCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ERC20TemplateCallerRaw struct {
	Contract *ERC20TemplateCaller // Generic read-only contract binding to access the raw methods on
}

// ERC20TemplateTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ERC20TemplateTransactorRaw struct {
	Contract *ERC20TemplateTransactor // Generic write-only contract binding to access the raw methods on
}

// NewERC20Template creates a new instance of ERC20Template, bound to a specific deployed contract.
func NewERC20Template(address common.Address, backend bind.ContractBackend) (*ERC20Template, error) {
	contract, err := bindERC20Template(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ERC20Template{ERC20TemplateCaller: ERC20TemplateCaller{contract: contract}, ERC20TemplateTransactor: ERC20TemplateTransactor{contract: contract}, ERC20TemplateFilterer: ERC20TemplateFilterer{contract: contract}}, nil
}

// NewERC20TemplateCaller creates a new read-only instance of ERC20Template, bound to a specific deployed contract.
func NewERC20TemplateCaller(address common.Address, caller bind.ContractCaller) (*ERC20TemplateCaller, error) {
	contract, err := bindERC20Template(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ERC20TemplateCaller{contract: contract}, nil
}

// NewERC20TemplateTransactor creates a new write-only instance of ERC20Template, bound to a specific deployed contract.
func NewERC20TemplateTransactor(address common.Address, transactor bind.ContractTransactor) (*ERC20TemplateTransactor, error) {
	contract, err := bindERC20Template(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ERC20TemplateTransactor{contract: contract}, nil
}

// NewERC20TemplateFilterer creates a new log filterer instance of ERC20Template, bound to a specific deployed contract.
func NewERC20TemplateFilterer(address common.Address, filterer bind.ContractFilterer) (*ERC20TemplateFilterer, error) {
	contract, err := bindERC20Template(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ERC20TemplateFilterer{contract: contract}, nil
}

// bindERC20Template binds a generic wrapper to an already deployed contract.
func bindERC20Template(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ERC20TemplateABI))
	if err != nil {
		return nil, err
	}
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ERC20Template *ERC20TemplateRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ERC20Template.Contract.ERC20TemplateTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ERC20Template *ERC20TemplateRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ERC20Template.Contract.ERC20TemplateTransactor.contract.Transact(opts, method, params...)
}
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ERC20Template *ERC20TemplateTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ERC20Template.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ERC20Template *ERC20TemplateTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ERC20Template.Contract.contract.Transact(opts, method, params...)
}
...
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_ERC20Template *ERC20TemplateSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _ERC20Template.Contract.Allowance(&_ERC20Template.CallOpts, owner, spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_ERC20Template *ERC20TemplateCallerSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _ERC20Template.Contract.Allowance(&_ERC20Template.CallOpts, owner, spender)
}
...
//
// Solidity: function balanceOf(address account) view returns(uint256)
func (_ERC20Template *ERC20TemplateSession) BalanceOf(account common.Address) (*big.Int, error) {
	return _ERC20Template.Contract.BalanceOf(&_ERC20Template.CallOpts, account)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address account) view returns(uint256)
func (_ERC20Template *ERC20TemplateCallerSession) BalanceOf(account common.Address) (*big.Int, error) {
	return _ERC20Template.Contract.BalanceOf(&_ERC20Template.CallOpts, account)
}
...
//
// Solidity: function decimals() view returns(uint8)
func (_ERC20Template *ERC20TemplateSession) Decimals() (uint8, error) {
	return _ERC20Template.Contract.Decimals(&_ERC20Template.CallOpts)
}

// Decimals is a free data retrieval call binding the contract method 0x313ce567.
//
// Solidity: function decimals() view returns(uint8)
func (_ERC20Template *ERC20TemplateCallerSession) Decimals() (uint8, error) {
	return _ERC20Template.Contract.Decimals(&_ERC20Template.CallOpts)
}
...
//
// Solidity: function name() view returns(string)
func (_ERC20Template *ERC20TemplateSession) Name() (string, error) {
	return _ERC20Template.Contract.Name(&_ERC20Template.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() view returns(string)
func (_ERC20Template *ERC20TemplateCallerSession) Name() (string, error) {
	return _ERC20Template.Contract.Name(&_ERC20Template.CallOpts)
}
...
//
// Solidity: function symbol() view returns(string)
func (_ERC20Template *ERC20TemplateSession) Symbol() (string, error) {
	return _ERC20Template.Contract.Symbol(&_ERC20Template.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() view returns(string)
func (_ERC20Template *ERC20TemplateCallerSession) Symbol() (string, error) {
	return _ERC20Template.Contract.Symbol(&_ERC20Template.CallOpts)
}
...
//
// Solidity: function totalSupply() view returns(uint256)
func (_ERC20Template *ERC20TemplateSession) TotalSupply() (*big.Int, error) {
	return _ERC20Template.Contract.TotalSupply(&_ERC20Template.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() view returns(uint256)
func (_ERC20Template *ERC20TemplateCallerSession) TotalSupply() (*big.Int, error) {
	return _ERC20Template.Contract.TotalSupply(&_ERC20Template.CallOpts)
}
...
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactor) Approve(opts *bind.TransactOpts, spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.contract.Transact(opts, "approve", spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateSession) Approve(spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.Approve(&_ERC20Template.TransactOpts, spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address spender, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactorSession) Approve(spender common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.Approve(&_ERC20Template.TransactOpts, spender, amount)
}
...
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20Template *ERC20TemplateTransactor) DecreaseAllowance(opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.contract.Transact(opts, "decreaseAllowance", spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0xa457c2d7.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20Template *ERC20TemplateSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.DecreaseAllowance(&_ERC20Template.TransactOpts, spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0xa457c2d7.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_ERC20Template *ERC20TemplateTransactorSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.DecreaseAllowance(&_ERC20Template.TransactOpts, spender, subtractedValue)
}
...
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20Template *ERC20TemplateTransactor) IncreaseAllowance(opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.contract.Transact(opts, "increaseAllowance", spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x39509351.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20Template *ERC20TemplateSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.IncreaseAllowance(&_ERC20Template.TransactOpts, spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x39509351.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_ERC20Template *ERC20TemplateTransactorSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.IncreaseAllowance(&_ERC20Template.TransactOpts, spender, addedValue)
}
...
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactor) Transfer(opts *bind.TransactOpts, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.contract.Transact(opts, "transfer", recipient, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateSession) Transfer(recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.Transfer(&_ERC20Template.TransactOpts, recipient, amount)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactorSession) Transfer(recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.Transfer(&_ERC20Template.TransactOpts, recipient, amount)
}
...
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactor) TransferFrom(opts *bind.TransactOpts, sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.contract.Transact(opts, "transferFrom", sender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateSession) TransferFrom(sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.TransferFrom(&_ERC20Template.TransactOpts, sender, recipient, amount)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address sender, address recipient, uint256 amount) returns(bool)
func (_ERC20Template *ERC20TemplateTransactorSession) TransferFrom(sender common.Address, recipient common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Template.Contract.TransferFrom(&_ERC20Template.TransactOpts, sender, recipient, amount)
}

// ERC20TemplateApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the ERC20Template contract.
type ERC20TemplateApprovalIterator struct {
	Event *ERC20TemplateApproval // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20TemplateApprovalIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20TemplateApproval)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20TemplateApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20TemplateApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20TemplateApproval represents a Approval event raised by the ERC20Template contract.
type ERC20TemplateApproval struct {
	Owner   common.Address
	Spender common.Address
	Value   *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*ERC20TemplateApprovalIterator, error) {
	...
	logs, sub, err := _ERC20Template.contract.FilterLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return &ERC20TemplateApprovalIterator{contract: _ERC20Template.contract, event: "Approval", logs: logs, sub: sub}, nil
}

// WatchApproval is a free log subscription operation binding the contract event 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925.
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *ERC20TemplateApproval, owner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20Template.contract.WatchLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20TemplateApproval)
...
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) ParseApproval(log types.Log) (*ERC20TemplateApproval, error) {
	event := new(ERC20TemplateApproval)
	if err := _ERC20Template.contract.UnpackLog(event, "Approval", log); err != nil {
		return nil, err
	}
...
// ERC20TemplateTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the ERC20Template contract.
type ERC20TemplateTransferIterator struct {
	Event *ERC20TemplateTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20TemplateTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20TemplateTransfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20TemplateTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20TemplateTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20TemplateTransfer represents a Transfer event raised by the ERC20Template contract.
type ERC20TemplateTransfer struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*ERC20TemplateTransferIterator, error) {
	...
	logs, sub, err := _ERC20Template.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ERC20TemplateTransferIterator{contract: _ERC20Template.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *ERC20TemplateTransfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20Template.contract.WatchLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20TemplateTransfer)
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_ERC20Template *ERC20TemplateFilterer) ParseTransfer(log types.Log) (*ERC20TemplateTransfer, error) {
	event := new(ERC20TemplateTransfer)
	if err := _ERC20Template.contract.UnpackLog(event, "Transfer", log); err != nil {
		return nil, err
	}
