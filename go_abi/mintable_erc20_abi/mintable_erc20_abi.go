...
func DeployMockDai(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *MockDai, error) {
	parsed, err := abi.JSON(strings.NewReader(MockDaiABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(MockDaiBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &MockDai{MockDaiCaller: MockDaiCaller{contract: contract}, MockDaiTransactor: MockDaiTransactor{contract: contract}, MockDaiFilterer: MockDaiFilterer{contract: contract}}, nil
}

// MockDai is an auto generated Go binding around an Ethereum contract.
type MockDai struct {
	MockDaiCaller     // Read-only binding to the contract
	MockDaiTransactor // Write-only binding to the contract
	MockDaiFilterer   // Log filterer for contract events
}

// MockDaiCaller is an auto generated read-only Go binding around an Ethereum contract.
type MockDaiCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// MockDaiTransactor is an auto generated write-only Go binding around an Ethereum contract.
type MockDaiTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// MockDaiFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type MockDaiFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// MockDaiSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type MockDaiSession struct {
	Contract     *MockDai          // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// MockDaiCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type MockDaiCallerSession struct {
	Contract *MockDaiCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts  // Call options to use throughout this session
}

// MockDaiTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type MockDaiTransactorSession struct {
	Contract     *MockDaiTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts  // Transaction auth options to use throughout this session
}

// MockDaiRaw is an auto generated low-level Go binding around an Ethereum contract.
type MockDaiRaw struct {
	Contract *MockDai // Generic contract binding to access the raw methods on
}

// MockDaiCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type MockDaiCallerRaw struct {
	Contract *MockDaiCaller // Generic read-only contract binding to access the raw methods on
}

// MockDaiTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type MockDaiTransactorRaw struct {
	Contract *MockDaiTransactor // Generic write-only contract binding to access the raw methods on
}

// NewMockDai creates a new instance of MockDai, bound to a specific deployed contract.
func NewMockDai(address common.Address, backend bind.ContractBackend) (*MockDai, error) {
	contract, err := bindMockDai(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &MockDai{MockDaiCaller: MockDaiCaller{contract: contract}, MockDaiTransactor: MockDaiTransactor{contract: contract}, MockDaiFilterer: MockDaiFilterer{contract: contract}}, nil
}

// NewMockDaiCaller creates a new read-only instance of MockDai, bound to a specific deployed contract.
func NewMockDaiCaller(address common.Address, caller bind.ContractCaller) (*MockDaiCaller, error) {
	contract, err := bindMockDai(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &MockDaiCaller{contract: contract}, nil
}

// NewMockDaiTransactor creates a new write-only instance of MockDai, bound to a specific deployed contract.
func NewMockDaiTransactor(address common.Address, transactor bind.ContractTransactor) (*MockDaiTransactor, error) {
	contract, err := bindMockDai(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &MockDaiTransactor{contract: contract}, nil
}

// NewMockDaiFilterer creates a new log filterer instance of MockDai, bound to a specific deployed contract.
func NewMockDaiFilterer(address common.Address, filterer bind.ContractFilterer) (*MockDaiFilterer, error) {
	contract, err := bindMockDai(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &MockDaiFilterer{contract: contract}, nil
}

// bindMockDai binds a generic wrapper to an already deployed contract.
func bindMockDai(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(MockDaiABI))
	if err != nil {
		return nil, err
	}
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_MockDai *MockDaiRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _MockDai.Contract.MockDaiTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_MockDai *MockDaiRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _MockDai.Contract.MockDaiTransactor.contract.Transact(opts, method, params...)
}
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_MockDai *MockDaiTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _MockDai.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_MockDai *MockDaiTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _MockDai.Contract.contract.Transact(opts, method, params...)
}
...
//
// Solidity: function DECIMALS() view returns(uint8)
func (_MockDai *MockDaiSession) DECIMALS() (uint8, error) {
	return _MockDai.Contract.DECIMALS(&_MockDai.CallOpts)
}

// DECIMALS is a free data retrieval call binding the contract method 0x2e0f2625.
//
// Solidity: function DECIMALS() view returns(uint8)
func (_MockDai *MockDaiCallerSession) DECIMALS() (uint8, error) {
	return _MockDai.Contract.DECIMALS(&_MockDai.CallOpts)
}
...
//
// Solidity: function INITIAL_SUPPLY() view returns(uint256)
func (_MockDai *MockDaiSession) INITIALSUPPLY() (*big.Int, error) {
	return _MockDai.Contract.INITIALSUPPLY(&_MockDai.CallOpts)
}

// INITIALSUPPLY is a free data retrieval call binding the contract method 0x2ff2e9dc.
//
// Solidity: function INITIAL_SUPPLY() view returns(uint256)
func (_MockDai *MockDaiCallerSession) INITIALSUPPLY() (*big.Int, error) {
	return _MockDai.Contract.INITIALSUPPLY(&_MockDai.CallOpts)
}
...
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_MockDai *MockDaiSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _MockDai.Contract.Allowance(&_MockDai.CallOpts, owner, spender)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address owner, address spender) view returns(uint256)
func (_MockDai *MockDaiCallerSession) Allowance(owner common.Address, spender common.Address) (*big.Int, error) {
	return _MockDai.Contract.Allowance(&_MockDai.CallOpts, owner, spender)
}
...
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_MockDai *MockDaiSession) BalanceOf(owner common.Address) (*big.Int, error) {
	return _MockDai.Contract.BalanceOf(&_MockDai.CallOpts, owner)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_MockDai *MockDaiCallerSession) BalanceOf(owner common.Address) (*big.Int, error) {
	return _MockDai.Contract.BalanceOf(&_MockDai.CallOpts, owner)
}
...
//
// Solidity: function isMinter(address account) view returns(bool)
func (_MockDai *MockDaiSession) IsMinter(account common.Address) (bool, error) {
	return _MockDai.Contract.IsMinter(&_MockDai.CallOpts, account)
}

// IsMinter is a free data retrieval call binding the contract method 0xaa271e1a.
//
// Solidity: function isMinter(address account) view returns(bool)
func (_MockDai *MockDaiCallerSession) IsMinter(account common.Address) (bool, error) {
	return _MockDai.Contract.IsMinter(&_MockDai.CallOpts, account)
}
...
//
// Solidity: function name() view returns(string)
func (_MockDai *MockDaiSession) Name() (string, error) {
	return _MockDai.Contract.Name(&_MockDai.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() view returns(string)
func (_MockDai *MockDaiCallerSession) Name() (string, error) {
	return _MockDai.Contract.Name(&_MockDai.CallOpts)
}
...
//
// Solidity: function symbol() view returns(string)
func (_MockDai *MockDaiSession) Symbol() (string, error) {
	return _MockDai.Contract.Symbol(&_MockDai.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() view returns(string)
func (_MockDai *MockDaiCallerSession) Symbol() (string, error) {
	return _MockDai.Contract.Symbol(&_MockDai.CallOpts)
}
...
//
// Solidity: function totalSupply() view returns(uint256)
func (_MockDai *MockDaiSession) TotalSupply() (*big.Int, error) {
	return _MockDai.Contract.TotalSupply(&_MockDai.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() view returns(uint256)
func (_MockDai *MockDaiCallerSession) TotalSupply() (*big.Int, error) {
	return _MockDai.Contract.TotalSupply(&_MockDai.CallOpts)
}
...
//
// Solidity: function addMinter(address account) returns()
func (_MockDai *MockDaiTransactor) AddMinter(opts *bind.TransactOpts, account common.Address) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "addMinter", account)
}

// AddMinter is a paid mutator transaction binding the contract method 0x983b2d56.
//
// Solidity: function addMinter(address account) returns()
func (_MockDai *MockDaiSession) AddMinter(account common.Address) (*types.Transaction, error) {
	return _MockDai.Contract.AddMinter(&_MockDai.TransactOpts, account)
}

// AddMinter is a paid mutator transaction binding the contract method 0x983b2d56.
//
// Solidity: function addMinter(address account) returns()
func (_MockDai *MockDaiTransactorSession) AddMinter(account common.Address) (*types.Transaction, error) {
	return _MockDai.Contract.AddMinter(&_MockDai.TransactOpts, account)
}
...
//
// Solidity: function approve(address spender, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactor) Approve(opts *bind.TransactOpts, spender common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "approve", spender, value)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address spender, uint256 value) returns(bool)
func (_MockDai *MockDaiSession) Approve(spender common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Approve(&_MockDai.TransactOpts, spender, value)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address spender, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactorSession) Approve(spender common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Approve(&_MockDai.TransactOpts, spender, value)
}
...
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_MockDai *MockDaiTransactor) DecreaseAllowance(opts *bind.TransactOpts, spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "decreaseAllowance", spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0xa457c2d7.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_MockDai *MockDaiSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.DecreaseAllowance(&_MockDai.TransactOpts, spender, subtractedValue)
}

// DecreaseAllowance is a paid mutator transaction binding the contract method 0xa457c2d7.
//
// Solidity: function decreaseAllowance(address spender, uint256 subtractedValue) returns(bool)
func (_MockDai *MockDaiTransactorSession) DecreaseAllowance(spender common.Address, subtractedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.DecreaseAllowance(&_MockDai.TransactOpts, spender, subtractedValue)
}
...
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_MockDai *MockDaiTransactor) IncreaseAllowance(opts *bind.TransactOpts, spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "increaseAllowance", spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x39509351.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_MockDai *MockDaiSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.IncreaseAllowance(&_MockDai.TransactOpts, spender, addedValue)
}

// IncreaseAllowance is a paid mutator transaction binding the contract method 0x39509351.
//
// Solidity: function increaseAllowance(address spender, uint256 addedValue) returns(bool)
func (_MockDai *MockDaiTransactorSession) IncreaseAllowance(spender common.Address, addedValue *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.IncreaseAllowance(&_MockDai.TransactOpts, spender, addedValue)
}
...
//
// Solidity: function mint(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactor) Mint(opts *bind.TransactOpts, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "mint", to, value)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiSession) Mint(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Mint(&_MockDai.TransactOpts, to, value)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactorSession) Mint(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Mint(&_MockDai.TransactOpts, to, value)
}
...
//
// Solidity: function renounceMinter() returns()
func (_MockDai *MockDaiTransactor) RenounceMinter(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "renounceMinter")
}

// RenounceMinter is a paid mutator transaction binding the contract method 0x98650275.
//
// Solidity: function renounceMinter() returns()
func (_MockDai *MockDaiSession) RenounceMinter() (*types.Transaction, error) {
	return _MockDai.Contract.RenounceMinter(&_MockDai.TransactOpts)
}

// RenounceMinter is a paid mutator transaction binding the contract method 0x98650275.
//
// Solidity: function renounceMinter() returns()
func (_MockDai *MockDaiTransactorSession) RenounceMinter() (*types.Transaction, error) {
	return _MockDai.Contract.RenounceMinter(&_MockDai.TransactOpts)
}
...
//
// Solidity: function transfer(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactor) Transfer(opts *bind.TransactOpts, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "transfer", to, value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiSession) Transfer(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Transfer(&_MockDai.TransactOpts, to, value)
}

// Transfer is a paid mutator transaction binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactorSession) Transfer(to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.Transfer(&_MockDai.TransactOpts, to, value)
}
...
//
// Solidity: function transferFrom(address from, address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.contract.Transact(opts, "transferFrom", from, to, value)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 value) returns(bool)
func (_MockDai *MockDaiSession) TransferFrom(from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.TransferFrom(&_MockDai.TransactOpts, from, to, value)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 value) returns(bool)
func (_MockDai *MockDaiTransactorSession) TransferFrom(from common.Address, to common.Address, value *big.Int) (*types.Transaction, error) {
	return _MockDai.Contract.TransferFrom(&_MockDai.TransactOpts, from, to, value)
}

// MockDaiApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the MockDai contract.
type MockDaiApprovalIterator struct {
	Event *MockDaiApproval // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MockDaiApprovalIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MockDaiApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MockDaiApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MockDaiApproval represents a Approval event raised by the MockDai contract.
type MockDaiApproval struct {
	Owner   common.Address
	Spender common.Address
	Value   *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_MockDai *MockDaiFilterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, spender []common.Address) (*MockDaiApprovalIterator, error) {
	...
	logs, sub, err := _MockDai.contract.FilterLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return &MockDaiApprovalIterator{contract: _MockDai.contract, event: "Approval", logs: logs, sub: sub}, nil
}

// WatchApproval is a free log subscription operation binding the contract event 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925.
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_MockDai *MockDaiFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *MockDaiApproval, owner []common.Address, spender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MockDai.contract.WatchLogs(opts, "Approval", ownerRule, spenderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event Approval(address indexed owner, address indexed spender, uint256 value)
func (_MockDai *MockDaiFilterer) ParseApproval(log types.Log) (*MockDaiApproval, error) {
	event := new(MockDaiApproval)
	if err := _MockDai.contract.UnpackLog(event, "Approval", log); err != nil {
		return nil, err
	}
...
// MockDaiMinterAddedIterator is returned from FilterMinterAdded and is used to iterate over the raw logs and unpacked data for MinterAdded events raised by the MockDai contract.
type MockDaiMinterAddedIterator struct {
	Event *MockDaiMinterAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MockDaiMinterAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MockDaiMinterAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MockDaiMinterAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MockDaiMinterAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MockDaiMinterAdded represents a MinterAdded event raised by the MockDai contract.
type MockDaiMinterAdded struct {
	Account common.Address
	Raw     types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event MinterAdded(address indexed account)
func (_MockDai *MockDaiFilterer) FilterMinterAdded(opts *bind.FilterOpts, account []common.Address) (*MockDaiMinterAddedIterator, error) {
	...
	logs, sub, err := _MockDai.contract.FilterLogs(opts, "MinterAdded", accountRule)
	if err != nil {
		return nil, err
	}
	return &MockDaiMinterAddedIterator{contract: _MockDai.contract, event: "MinterAdded", logs: logs, sub: sub}, nil
}

// WatchMinterAdded is a free log subscription operation binding the contract event 0x6ae172837ea30b801fbfcdd4108aa1d5bf8ff775444fd70256b44e6bf3dfc3f6.
//
// Solidity: event MinterAdded(address indexed account)
func (_MockDai *MockDaiFilterer) WatchMinterAdded(opts *bind.WatchOpts, sink chan<- *MockDaiMinterAdded, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MockDai.contract.WatchLogs(opts, "MinterAdded", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event MinterAdded(address indexed account)
func (_MockDai *MockDaiFilterer) ParseMinterAdded(log types.Log) (*MockDaiMinterAdded, error) {
	event := new(MockDaiMinterAdded)
	if err := _MockDai.contract.UnpackLog(event, "MinterAdded", log); err != nil {
		return nil, err
	}
...
// MockDaiMinterRemovedIterator is returned from FilterMinterRemoved and is used to iterate over the raw logs and unpacked data for MinterRemoved events raised by the MockDai contract.
type MockDaiMinterRemovedIterator struct {
	Event *MockDaiMinterRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MockDaiMinterRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MockDaiMinterRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MockDaiMinterRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MockDaiMinterRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MockDaiMinterRemoved represents a MinterRemoved event raised by the MockDai contract.
type MockDaiMinterRemoved struct {
	Account common.Address
	Raw     types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event MinterRemoved(address indexed account)
func (_MockDai *MockDaiFilterer) FilterMinterRemoved(opts *bind.FilterOpts, account []common.Address) (*MockDaiMinterRemovedIterator, error) {
	...
	logs, sub, err := _MockDai.contract.FilterLogs(opts, "MinterRemoved", accountRule)
	if err != nil {
		return nil, err
	}
	return &MockDaiMinterRemovedIterator{contract: _MockDai.contract, event: "MinterRemoved", logs: logs, sub: sub}, nil
}

// WatchMinterRemoved is a free log subscription operation binding the contract event 0xe94479a9f7e1952cc78f2d6baab678adc1b772d936c6583def489e524cb66692.
//
// Solidity: event MinterRemoved(address indexed account)
func (_MockDai *MockDaiFilterer) WatchMinterRemoved(opts *bind.WatchOpts, sink chan<- *MockDaiMinterRemoved, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MockDai.contract.WatchLogs(opts, "MinterRemoved", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MockDaiMinterRemoved)
...
//
// Solidity: event MinterRemoved(address indexed account)
func (_MockDai *MockDaiFilterer) ParseMinterRemoved(log types.Log) (*MockDaiMinterRemoved, error) {
	event := new(MockDaiMinterRemoved)
	if err := _MockDai.contract.UnpackLog(event, "MinterRemoved", log); err != nil {
		return nil, err
	}
...
// MockDaiTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the MockDai contract.
type MockDaiTransferIterator struct {
	Event *MockDaiTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MockDaiTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MockDaiTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MockDaiTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MockDaiTransfer represents a Transfer event raised by the MockDai contract.
type MockDaiTransfer struct {
	From  common.Address
	To    common.Address
	Value *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_MockDai *MockDaiFilterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*MockDaiTransferIterator, error) {
	...
	logs, sub, err := _MockDai.contract.FilterLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &MockDaiTransferIterator{contract: _MockDai.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_MockDai *MockDaiFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *MockDaiTransfer, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MockDai.contract.WatchLogs(opts, "Transfer", fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 value)
func (_MockDai *MockDaiFilterer) ParseTransfer(log types.Log) (*MockDaiTransfer, error) {
	event := new(MockDaiTransfer)
	if err := _MockDai.contract.UnpackLog(event, "Transfer", log); err != nil {
		return nil, err
	}
