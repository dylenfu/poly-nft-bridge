...
// DeployLockProxy deploys a new Ethereum contract, binding an instance of NFTLockProxy to it.
...
// NewLockProxy creates a new instance of NFTLockProxy, bound to a specific deployed contract.
...
// NewLockProxyCaller creates a new read-only instance of NFTLockProxy, bound to a specific deployed contract.
...
// NewLockProxyTransactor creates a new write-only instance of NFTLockProxy, bound to a specific deployed contract.
...
// NewLockProxyFilterer creates a new log filterer instance of NFTLockProxy, bound to a specific deployed contract.
...
// LockProxyBindAssetEventIterator is returned from FilterBindAssetEvent and is used to iterate over the raw logs and unpacked data for BindAssetEvent events raised by the NFTLockProxy contract.
...
// LockProxyBindAssetEvent represents a BindAssetEvent event raised by the NFTLockProxy contract.
...
// LockProxyBindProxyEventIterator is returned from FilterBindProxyEvent and is used to iterate over the raw logs and unpacked data for BindProxyEvent events raised by the NFTLockProxy contract.
...
// LockProxyBindProxyEvent represents a BindProxyEvent event raised by the NFTLockProxy contract.
...
// LockProxyLockEventIterator is returned from FilterLockEvent and is used to iterate over the raw logs and unpacked data for LockEvent events raised by the NFTLockProxy contract.
...
// LockProxyLockEvent represents a LockEvent event raised by the NFTLockProxy contract.
...
// LockProxyOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the NFTLockProxy contract.
...
// LockProxyOwnershipTransferred represents a OwnershipTransferred event raised by the NFTLockProxy contract.
...
// LockProxySetManagerProxyEventIterator is returned from FilterSetManagerProxyEvent and is used to iterate over the raw logs and unpacked data for SetManagerProxyEvent events raised by the NFTLockProxy contract.
...
// LockProxySetManagerProxyEvent represents a SetManagerProxyEvent event raised by the NFTLockProxy contract.
...
// LockProxyUnlockEventIterator is returned from FilterUnlockEvent and is used to iterate over the raw logs and unpacked data for UnlockEvent events raised by the NFTLockProxy contract.
...
// LockProxyUnlockEvent represents a UnlockEvent event raised by the NFTLockProxy contract.
